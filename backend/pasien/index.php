...
<head>
        <meta charset="utf-8" />
        <title>Sistem Manajemen Rumah Saki</title>
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Masukkan alamat email dan kata sandi Anda untuk mengakses.</p>
                                </div>

                                <form method='post' >

                                    <div class="form-group mb-3">
                                        <label for="emailaddress">Pasient ID</label>
