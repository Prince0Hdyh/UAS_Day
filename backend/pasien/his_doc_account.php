                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Nama :  </strong> <span class="ml-2">Hidayah</span></p>
                                       <p class="text-muted mb-2 font-13"><strong>Pekerjaan :</strong> <span class="ml-2">Mahasiswi</span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Nomor HP :</strong> <span class="ml-2">01010177777</span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Email:</strong> <span class="ml-2">HidayahGans@gmail.com</span></p>
